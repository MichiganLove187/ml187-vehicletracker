...
-- QB Usable Items
QBCore.Functions.CreateUseableItem(Config.Items.tracker, function(source, item)
...
QBCore.Functions.CreateUseableItem(Config.Items.tablet, function(source, item)
...
QBCore.Functions.CreateUseableItem(Config.Items.scanner, function(source, item)
...
lib.callback.register('vehicle_tracker:placeTracker', function(source, vehiclePlate, slot, serialNumber)
    ...
    TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items[Config.Items.tracker], 'remove')
...
lib.callback.register('vehicle_tracker:removeTracker', function(source, vehiclePlate, slot)
    ...
    TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items[Config.Items.scanner], 'remove')
